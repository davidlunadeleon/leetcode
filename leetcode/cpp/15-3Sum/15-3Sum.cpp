...
/*
   ...
   in leetcode. My original submission had a similar approach but was slower and
   was not enough to pass test case 311 in the platform. The main changes are
   the use of sets instead of only vectors, and the approach to the two sum
   function, using two pointers instead of a hashmap.
*/

...
void makeTest() {
	...
	for (int i = 0; i < numElements; i++) {
		string temp;
		// Introduce the element with the following format: "element". This is
		// in case you want to use an empty string.
		cin >> temp;
	...
	cout << (correctAns == Solution().longestCommonPrefix(vectStrings)
				 ? "pass\n"
				 : "fail\n");
}
